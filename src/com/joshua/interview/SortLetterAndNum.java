...
public class SortLetterAndNum {
	public static void main(String[] args) {
		char[] chs = { '2', '1', 'd', '4', 'a', '9', 'f', '3', '2',  };

		SortLetterAndNum yh = new SortLetterAndNum();
	...
	public char[] sortArray(char[] chs) {
		ListAndPosition c = partition(chs);
	...
	public ListAndPosition partition(char[] chs) {
		...
		return new ListAndPosition(helper, leftPivot - 1);
	}
